...
VALUES 
    (2, 1, '2025-05-01 10:00:00', 'зарегистрировано', 'участник'),   -- ДрифтКинг на Дрифт Битва 2025 как участник
    (4, 2, '2025-05-01 10:05:00', 'зарегистрировано', 'зритель'),   -- СкоростнаяКоролева на Дрифт Фест как зритель
    (2, 3, '2025-05-18 10:10:00', 'зарегистрировано', 'зритель'),   -- ДрифтКинг на Большие гонки как зритель
    (4, 1, '2025-05-01 10:15:00', 'отменено', 'участник'),         -- СкоростнаяКоролева на Дрифт Битва 2025 как участник (отменено)
    ...
    (8, 6, '2025-05-01 10:30:00', 'зарегистрировано', 'зритель'),   -- НочнойГонщик на Казанский Дрифт-Фест как зритель
    ...
    (9, 1, '2025-05-01 10:45:00', 'зарегистрировано', 'участник'),  -- ДрифтЛеди на Дрифт Битва 2025 как участник
    (6, 2, '2025-05-01 10:50:00', 'зарегистрировано', 'зритель'),   -- ДрифтМастер на Дрифт Фест как зритель
...
VALUES 
    (1, 2500.00, '2025-05-01 10:15:00', 'оплачено'),    -- Оплата ДрифтКинга за Дрифт Битва 2025 (участник)
    (2, 300.00, '2025-05-01 10:20:00', 'оплачено'),     -- Оплата СкоростнойКоролевы за Дрифт Фест (зритель)
    (3, 500.00, '2025-05-18 10:25:00', 'ожидает оплаты'),   -- Оплата ДрифтКинга за Большие гонки (зритель)
    (4, 2500.00, '2025-05-01 10:30:00', 'оплачено'),    -- Оплата СкоростнойКоролевы за Дрифт Битва 2025 (участник)
    (5, 1800.00, '2025-05-18 10:35:00', 'ожидает оплаты'),  -- Оплата ТурбоМакса за Питерский Дрифт 2025 (участник)
    (6, 1700.00, '2025-05-18 10:40:00', 'ожидает оплаты'),  -- Оплата ДрифтМастера за Екатеринбург Дрифт (участник)
    (7, 450.00, '2025-05-01 10:45:00', 'оплачено'),     -- Оплата НочногоГонщика за Казанский Дрифт-Фест (зритель)
    (8, 2000.00, '2025-05-18 10:50:00', 'оплачено'),    -- Оплата ДрифтЛеди за Сибирский Заезд (участник)
    (9, 700.00, '2025-05-18 10:55:00', 'ожидает оплаты'),   -- Оплата ТурбоМакса за Московский Финал (зритель)
    (10, 2500.00, '2025-05-01 11:00:00', 'оплачено'),   -- Оплата ДрифтЛеди за Дрифт Битва 2025 (участник)
    (11, 300.00, '2025-05-01 11:05:00', 'оплачено'),    -- Оплата ДрифтМастера за Дрифт Фест (зритель)
    (12, 1800.00, '2025-05-18 11:10:00', 'ожидает оплаты'); -- Оплата НочногоГонщика за Питерский Дрифт 2025 (участник)
...
-- Вставка отзывов (только для завершенных мероприятий с датами до 18 мая 2025)
INSERT INTO Reviews (user_id, event_id, rating, comment)
VALUES 
    (2, 1, 5, 'Лучшая дрифт-битва, в которой я участвовал! Организация на высоте!'), -- Отзыв ДрифтКинга о Дрифт Битва 2025
    (4, 2, 3, 'Ожидала большего, мало участников, но атмосфера была неплохая.'),     -- Отзыв СкоростнойКоролевы о Дрифт Фест
    (8, 6, 4, 'Отличное мероприятие, но парковка была переполнена, что испортило впечатление.'), -- Отзыв НочногоГонщика о Казанский Дрифт-Фест
    (6, 6, 5, 'Шикарное шоу, всё на уровне! Жду следующего раза!'),                   -- Отзыв ДрифтМастера о Казанский Дрифт-Фест
    (9, 1, 4, 'Хорошая организация, но трасса могла бы быть длиннее.'),               -- Отзыв ДрифтЛеди о Дрифт Битва 2025
    (4, 6, 3, 'Интересно, но звук был слабоват, ожидала больше драйва.');            -- Отзыв СкоростнойКоролевы о Казанский Дрифт-Фест
